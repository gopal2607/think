...
//		landingpage.waitForElementToAppear(By.xpath("//div[text()='Ein neues Asset wird erstellt.']")); //Waiting for 'Editier-Modus ist aktiv.' toast after campaign added
		landingpage.waitForElementToAppear(By.xpath("//div[text()='Einstellungen als neues Werbemittel gespeichert.']")); //Waiting for 'Editier-Modus ist aktiv.' toast after campaign added
	...
	@Test(description ="Verify that duplicate campaign should works", retryAnalyzer = Retry.class, priority = 0 )
	...
	public void duplicateList() throws InterruptedException {
		...
		displayBanner.clickOnDisplayBanner(); //Click on the display banner
		displayBanner.zuDenButton.get(0).click(); //Click on the mit motive type from the display banner screen 
		landingpage.waitForWebElementToAppear(displayBanner.ceativeListing.get(0));  //waiting to  creative listing appear
		...
		displayBanner.closeBtn.click();
		
		Thread.sleep(2000);
		WebElement element1 = driver.findElement(By.xpath("//*[text() = 'creative preview']")); // click on the creative preview 
		((JavascriptExecutor) driver).executeScript("arguments[0].click();", element1);
		
		landingpage.waitForWebElementToAppear(displayBanner.ceativeListHeadline.get(0));  //waiting to  creative listing appear
	...
	public void deleteList() throws InterruptedException {
		...
		displayBanner.clickOnDisplayBanner(); //Click on the display banner
		displayBanner.zuDenButton.get(0).click(); //Click on the mit motive type from the display banner screen 
		landingpage.waitForListOfWebElementToAppear(displayBanner.ceativeListVorschauBtn);
	    ...
	    displayBanner.ceativeListReallyDeleteBtn.click(); //click on the delete

		landingpage.waitForListOfWebElementToAppear(displayBanner.ceativeListVorschauBtn);

		displayBanner.ceativeListVorschauBtn.get(1).click();  //Click on the mit motive type from the display banner screen 
