...
//	-------------------------------------Creative Preview Page------------------------------------------------------------------------------
	...
	public void diffResoAds(WebElement frame, String replaceText) throws InterruptedException {
...
//        editPreviewArray[6] = displayBanner.cta.getAttribute("value");  
		...
		actualPreviewArray[3] = displayBanner.actualMotif.getAttribute("src").replace(replaceText, "");
		actualPreviewArray[4] = displayBanner.actualBg.getAttribute("src").replace(replaceText, "");
...
//        actualPreviewArray[6] = displayBanner.actualCta.getText().replaceAll("\\s+", " ").trim(); CTA is not possible because in the cta div, we didn't have text
		...
		softAssert.assertEquals("actualPreviewArray : " + actualPreviewArray, editPreviewArray);
